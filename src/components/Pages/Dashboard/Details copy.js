...
const Details = ({ userId }) => {
  ...
  const historyHandler = () => {
    ...
    // https://es-demo.azurewebsites.net/v1/People/01/history?from=1.1.1990
  ...
  const allHistoryData = userHistory ? userHistory.map((item, i) =>
  ...
  return (
    <>
      ...
      <div className="container">
          ...
          <div className="col-12">
            ...
            <form className="file-upload" onSubmit={formik.handleSubmit}>
              <div className="row mb-1 gx-5">
                <div className="col-xl-8 mb-1 mb-xxl-10">
                  <div className="bg-secondary-soft px-4 py-3 rounded">
                    <div className="row g-3">
                      ...
                      <div className="col-md-12">
                        ...
                        // value={userData.name ? formik.values.name : ""}
                      ...
                      <div className="col-md-12">
                        ...
                        <input
                          ...
                          // defaultValue={userData ? Moment(userData.changedAt).format('DD.MM.YYYY, h:mm:ss A') : userData.changedAt}
                          //defaultValue={userData.changedAt}
                          readOnly="readonly"
                        />
                      </div>
                      <div className="col-md-12">
                        ...
                        <input
                          ...
                          // defaultValue={userData.originalRevision}
                          readOnly="readonly"
                        />
                      </div>
                    </div>
                  ...
                  <div className="gap-5 d-flex justify-content-center text-center" >
                    <button type="button" className="btn btn-danger btn-lg" onClick={deleteHandler} >
                      {/* <button type="button" className="btn btn-danger btn-lg" onClick={showDeleteToastHandler} > */}
                      Delete profile
                    </button>
                    {/* <button type="submit" className="btn btn-primary btn-lg" onClick={updateDataHandler}> */}
                    <button type="submit" className="btn btn-primary btn-lg">
                      Update profile
                    </button>
                    <button type="button" className="btn btn-warning btn-lg text-white fw-bold" onClick={historyHandler}>
                      History
                    </button>
                    <Link type="button" className="btn btn-success btn-lg" to={"/dashboard"}>
                      Back
                    </Link>
                  </div>
        ...
        <div>
          {showHistory && <History historyData={allHistoryData} />}
        </div>
      </div>
    </>
  );
